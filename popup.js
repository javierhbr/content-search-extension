...
class ConfigManager {
  ...
  static validateConfig(config) {
    return config && Array.isArray(config.options) && config.options.every(
      (option) => typeof option.label === "string" && typeof option.searchValue === "string"
    );
  }
}
__publicField(ConfigManager, "STORAGE_KEY", "searchConfig");
function isValidDomainForGolden(url) {
  return GOLDEN_CALL_DOMAINS.some((domain) => url.includes(domain));
}
function isValidDomainForSearch(url) {
...
const SearchTab = ({
  ...
  const handleConfigButtonRightClick = (event) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "tab-pane", role: "tabpanel", "aria-labelledby": "search-tab", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "page-header", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Search Configuration" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "search-container", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "search-header-controls", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "searchInput", children: "Search for:" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "config-controls", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `config-status ${configStatus.type}`, children: configStatus.message })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "custom-select", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "text",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "dropdown-arrow", "aria-hidden": "true", children: "▼" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "dropdown-options", role: "listbox", "aria-label": "Search options", children: filteredOptions.map((option, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mode-controls", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          className: `mode-button ${currentMode === "normal" ? "active" : ""}`,
          onClick: () => onModeChange("normal"),
          children: "Normal Search"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
    ...
    currentMode === "logs" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "logs-container", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: "Log Search Options:" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "logs-options", children: logOptions.map((option) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "button-help", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("small", { id: "search-help", className: "help-text", children: "Find and highlight text on the current page" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("small", { id: "clear-help", className: "help-text", children: "Remove all highlights from the page" })
    ] })
  ] });
};
const GoldenCallTab = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "tab-pane", role: "tabpanel", "aria-labelledby": "goldencall-tab", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "page-header", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Golden Call Configuration" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "golden-container", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "goldenInput", children: "Golden ID:" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          type: "text",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "button-group", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: isAutoPopulating ? "Auto-populating..." : "Get Golden"
        }
      ) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "golden-help", children: /* @__PURE__ */ jsxRuntimeExports.jsx("small", { className: "help-text", children: "Extract Golden ID from GitHub URLs or enter manually" }) })
    ] })
  ] });
};
const TabNavigation = ({ activeTab, onTabChange }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "tab-navigation", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "logo-area", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "logo-placeholder", title: "Extension Logo", children: "🔍" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "tabs-area", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
...
const StatusMessage = ({ message, type, onClose }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `status-message ${type}`, children: [
...
const App = () => {
  ...
  const [goldenId, setGoldenId] = reactExports.useState("");
  const [status, setStatus] = reactExports.useState(null);
  const [configStatus, setConfigStatus] = reactExports.useState({
  ...
  const setupOptions = async () => {
    try {
      ...
      setState((prev) => ({ ...prev, filteredOptions: config.options }));
  ...
  const autoPopulateGoldenCall = async () => {
    if (state.isAutoPopulating) return;
    setState((prev) => ({ ...prev, isAutoPopulating: true }));
    try {
      const [tab] = await chrome.tabs.query({ active: true, currentWindow: true });
      if ((tab == null ? void 0 : tab.id) && (tab == null ? void 0 : tab.url) && isValidDomainForGolden(tab.url)) {
        await injectContentScript(tab.id);
        const response = await chrome.tabs.sendMessage(tab.id, { action: "getGolden" });
        if (response == null ? void 0 : response.goldenId) {
      ...
      setState((prev) => ({ ...prev, isAutoPopulating: false }));
    }
  };
  ...
  const handleInputChange = (value) => {
    const filtered = options.filter(
      (option) => option.label.toLowerCase().includes(value.toLowerCase()) || option.searchValue.toLowerCase().includes(value.toLowerCase())
    );
    setState((prev) => ({
      ...prev,
      selectedValue: value,
  ...
  const handleConfigLoad = async (file) => {
    try {
  ...
  const handleLogOptionSelect = (searchTerm) => {
    setState((prev) => ({ ...prev, selectedValue: searchTerm }));
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "tab-content", children: [
      state.activeTab === "search" && /* @__PURE__ */ jsxRuntimeExports.jsx(
        SearchTab,
        {
      ...
      state.activeTab === "goldencall" && /* @__PURE__ */ jsxRuntimeExports.jsx(
        GoldenCallTab,
        {
          goldenId,
